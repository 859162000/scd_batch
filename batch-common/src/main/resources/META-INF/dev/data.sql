...
10, 3, 13, 1, 'project_code2',
1, CURRENT_DATE, '1');


INSERT INTO `bid_borrower_relation` VALUES
('1', 'project_code2', '1', '123456', '12345678',null, '你大爷', 'daye', '北京市朝阳区', '2016-09-08 12:10:17','2016-09-08 12:10:17', '1'),
...
1, 'order_seq_no', 'project_code2', 'product_code2', 'previous_seq_no',
...
insert into bid_creditor_relation values(
1, 'order_seq_no', 'project_code2', 'product_code3', 'previous_seq_no',
'order_flow_no', 'previous_flow_no', 'buyer_uid', 'seller_uid', 'borrower_id',
10000, '1', CURRENT_TIMESTAMP,3000, 3000,
2122, 111,3333, 4444,2222,
111,111,111,3,1,
...
1,'name','alias','0','1000',
'description','0.02', 10, 1, CURRENT_DATE,
CURRENT_DATE,'create_by','update_by'
);

insert into promotion_coupons_use_records values(
100, 1, 'user_id', '105', '66',
