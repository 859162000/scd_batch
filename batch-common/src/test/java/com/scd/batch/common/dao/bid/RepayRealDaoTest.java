...
public class RepayRealDaoTest extends AbstractJUnit4SpringContextTests {
    ...
    public void testGetProjectRepayPlanListByTerm() {
        ...
        List<BorrowerRepayEntity> repayEntityList = repayRealDao.getProjectRealRepayListByTerm(TestUtil.getTableSpec(),
    ...
    public void testGetProjectLimitList() {
        List<RepayPlanStatEntity> list = repayRealDao.getProjectLimitList(TestUtil.getTableSpec(), TestUtil
